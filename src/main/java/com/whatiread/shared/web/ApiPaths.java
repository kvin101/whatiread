...
public final class ApiPaths {
    ...
    public static final String AUTH_USERNAME_AVAILABLE = AUTH + "/username/available";
    ...
    public static final String BOOKS_SUGGEST = BOOKS + "/suggest";
    public static final String BOOKS_EXTERNAL_PREVIEW = BOOKS + "/external-preview";
    ...
    public static final String PUBLIC_AVATARS = PUBLIC + "/avatars";
